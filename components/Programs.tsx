...
const programs = [
  ...
  },
  {
    ...
    body: 'One on one coaching built entirely around your goals, your body, and your sport.',
    detail: '1-on-1',
    accent: 'green',
  ...
  },
  {
    ...
    title: 'VERSACLIMBER\nFUBAR',
    tag: '30 Minutes',
    body: "30-minute HIIT workouts on the world's best cardio machine. Coached. Maximum output.",
    detail: '30 Minutes',
    accent: 'green',
